...
public class Board extends JPanel implements Runnable, Commons {
	...
	private Shoot shot;
//	private Vector<Shoot> shot1 = new Vector<Shoot>();

	private final int ALIEN_INIT_X = 200; // 150
	...
	public void gameInit() {
		...
		for (int i = 0; i < 4; i++) {
			for (int j = 0; j < 6; j++) {
				...
				Alien alien = new Alien(ALIEN_INIT_X + 20 * j, ALIEN_INIT_Y + 20 * i);
				aliens.add(alien);
	...
	public void gameOver() {
		...
		Font small = new Font("Bob's Burger", Font.BOLD, 14);
